...
public class GetTwitterData {
	...
	final static int maxLoops = 20000;
	...
	static String searchString = "Galaxy S5";
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File("output/twitter-" + df.format( new Date() ) + ".txt");
	...
	static void refreshTweets() throws IOException // Umgehen der 100 - Sperre
	{
